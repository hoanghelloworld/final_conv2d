...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.do_convolution.autotvin_out_stream_V.dat"
         "c.do_convolution.autotvin_in_stream_V.dat"
         "c.do_convolution.autotvout_out_stream_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.do_convolution.autotvout_out_stream_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
