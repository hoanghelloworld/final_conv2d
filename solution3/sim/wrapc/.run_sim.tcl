...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "do_convolution.autotvin.dat"
	set constFileTvOut       "do_convolution.autotvout.dat"
	set constFileHdlTvIn     "do_convolution.autohdltvin.dat"
	set constFileHdlTvOut    "do_convolution.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
