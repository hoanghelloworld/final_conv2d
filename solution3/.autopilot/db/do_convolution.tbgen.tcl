set C_TypeInfoList {{ 
"do_convolution" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"out_stream": [[], {"reference": "0"}] }, {"in_stream": [[], {"reference": "0"}] }],[],""], 
"0": [ "stream<int>", {"hls_type": {"stream": [[[[], {"scalar": "int"}]],"1"]}}],
"1": ["hls", ""]
}}
...
set ArgLastReadFirstWriteLatency {
	do_convolution {
		out_stream_V {Type O LastRead -1 FirstWrite 11}
...
set fifoSchedulingInfoList { 
	out_stream_V { fifo_write 25 no_conditional }
	in_stream_V { fifo_read 32 has_conditional }
}
