...
set C_modelArgList {
	...
	{ data_in int 32 regular {array 25 { 1 3 } 1 1 }  }
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "1736", "EstimateLatencyMax" : "1736",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"InDataflowNetwork" : "0",
...
set ArgLastReadFirstWriteLatency {
	do_convolution {
		data_out {Type O LastRead -1 FirstWrite 4}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1736", "Max" : "1736"}
...
set Spec2ImplPortList { 
	...
	data_in { ap_memory {  { data_in_address0 mem_address 1 5 }  { data_in_ce0 mem_ce 1 1 }  { data_in_q0 mem_dout 0 32 } } }
