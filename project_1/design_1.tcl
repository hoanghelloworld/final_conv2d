...
xilinx.com:hls:do_convolution:0.0\
...
proc create_root_design { parentCell } {
  ...
  set in_stream_V_0 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:acc_fifo_read_rtl:1.0 in_stream_V_0 ]
  set out_stream_V_0 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:acc_fifo_write_rtl:1.0 out_stream_V_0 ]
  ...
  # Create instance: do_convolution_0, and set properties
  set do_convolution_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:do_convolution:0.0 do_convolution_0 ]
  ...
  connect_bd_intf_net -intf_net ap_ctrl_0_1 [get_bd_intf_ports ap_ctrl_0] [get_bd_intf_pins do_convolution_0/ap_ctrl]
  connect_bd_intf_net -intf_net do_convolution_0_in_stream_V [get_bd_intf_ports in_stream_V_0] [get_bd_intf_pins do_convolution_0/in_stream_V]
  connect_bd_intf_net -intf_net do_convolution_0_out_stream_V [get_bd_intf_ports out_stream_V_0] [get_bd_intf_pins do_convolution_0/out_stream_V]
  ...
  connect_bd_net -net axi_timer_0_generateout0 [get_bd_pins axi_timer_0/generateout0] [get_bd_pins do_convolution_0/ap_start]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_fifo_mm_s_0/s_axi_aclk] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins do_convolution_0/ap_clk] [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins rst_ps7_0_10M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in] [get_bd_pins rst_ps7_0_10M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_fifo_mm_s_0/s_axi_aresetn] [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  connect_bd_net -net rst_ps7_0_10M_peripheral_reset [get_bd_pins do_convolution_0/ap_rst] [get_bd_pins rst_ps7_0_10M/peripheral_reset]
